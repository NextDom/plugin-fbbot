    ...
    <div class="col-lg-2 col-md-3 col-sm-4">
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un fbbot}}</a>
...
foreach ($eqLogics as $eqLogic) {
  ...
  <br /><br />
  <legend><i class="fa fa-table"></i> {{Mes fbbots}}</legend>
	<div class="eqLogicThumbnailContainer">
    <?php
	foreach ($eqLogics as $eqLogic) {
		$opacity = ($eqLogic->getIsEnable()) ? '' : jeedom::getConfiguration('eqLogic:style:noactive');
    ...
    <form class="form-horizontal">
        <fieldset>
            <div class="form-group">
                <label class="col-sm-3 control-label">{{Nom de l'équipement fbbot}}</label>
                <div class="col-sm-3">
...
?>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-9">
        <span><?php echo network::getNetworkAccess('external') . '/plugins/fbbot/core/php/jeeFb.php';?></span>
  </div>
    </div>
    <div class="form-group">
      <label class="col-sm-3 control-label">{{Verify Token}}</label>
      <div class="col-lg-9">
        <span><?php echo jeedom::getApiKey('fbbot');?></span>
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label class="col-sm-3 control-label">{{Facebook API Graph Access Token}}</label>
      <div class="col-lg-9">
...
<?php include_file('desktop', 'fbbot', 'js', 'fbbot');?>
